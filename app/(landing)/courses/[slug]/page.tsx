...
import {BookOpen, Calendar, CheckCircle, Code, Target, Trophy, Users} from "lucide-react";
                                    ...
                                    <Card key={module.id} className="overflow-hidden shadow-xs">
                                        <CardHeader className="pb-3">
                                            <div className="flex items-start gap-3">
                                                <div
                                                    className="w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-sm font-semibold flex-shrink-0">
                                                    {index + 1}
                                                </div>
                                        ...
                                        {module.topics?.length > 0 && (
                                            <CardContent className="pt-0">
                                                <div className="space-y-2">
                                                    <h4 className="text-sm font-medium text-muted-foreground">Topics
                                                        Covered:</h4>
                        ...
                        <div className="sticky top-8">
                            <Card className="overflow-hidden  shadow-sm">
                                <CardHeader className="text-center space-y-4">
                                    ...
                                    <EnrollButton courseId={courseDetails.documentId}/>
                                </CardHeader>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="space-y-2 text-sm">
                                            <div className="flex justify-between">
                                                ...
                                                <span
                                                    className="font-medium">{dayjs(courseDetails.registrationStartDate).format("MMM DD")} - {dayjs(courseDetails.registrationEndDate).format("MMM DD")}</span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span className="text-muted-foreground">Classes Start:</span>
                                                <span
                                                    className="font-medium">{dayjs(courseDetails.classStartDate).format("MMM DD YYYY")}</span>
                                            </div>
                                        </div>
                                    </div>
